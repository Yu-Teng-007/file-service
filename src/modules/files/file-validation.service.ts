...
import { FileCategory, FileTypeConfig, FILE_TYPE_CONFIGS, CATEGORY_CONFIGS } from "../../types/file.types";
...
export class FileValidationService {
     ...
     * 验证文件内容
     */
    private async validateFileContent(file: Express.Multer.File, config: FileTypeConfig): Promise<void> {
        // 读取文件头部字节进行验证
